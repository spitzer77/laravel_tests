            ...
            <div class="row" id="table-hover-row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <Link :href="route('test2.index')" class="btn btn-primary me-1 waves-effect waves-float waves-light">Back</Link>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input disabled v-model="person" type="text" id="input-person" class="form-control rounded-lg border-1 border-gray-400" placeholder="Person">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input disabled v-model="test_date" type="date" id="input-test-date" class="form-control rounded-lg border-1 border-gray-400" placeholder="Test date">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input disabled v-model="location" id="input-location" type="text" class="form-control rounded-lg border-1 border-gray-400" placeholder="Location">
                                                    </div>
                                                </div>
                                            </div>
